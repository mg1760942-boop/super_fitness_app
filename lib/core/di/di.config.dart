...
import '../../src/data/data_source/offline_datasource/auth_offline_data_source.dart'
    as _i360;
import '../../src/data/data_source/offline_datasource/auth_offline_data_source_impl.dart'
    as _i746;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i360.AuthOfflineDataSource>(
        () => _i746.AuthOfflineDataSourceImpl());
    ...
    gh.factory<_i701.AuthRepository>(() => _i478.AuthRepositoryImpl(
          ...
          gh<_i360.AuthOfflineDataSource>(),
        ));
