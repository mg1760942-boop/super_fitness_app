        ...
        child: Column(
          ...
          children: [
            ...
            InfoSelectionEditProfileWidget(
                title: context.localizations.yourWeightTab,
                titleForm: editProfileViewModel.selectWeight.toString(),
                onTap: () =>
                    editProfileViewModel.doAction(GoNextPageWeightAction())),
            verticalSpace(16),
            InfoSelectionEditProfileWidget(
                title: context.localizations.yourGoalTab,
                titleForm: editProfileViewModel.selectedGoal.toString(),
                onTap: () =>
                    editProfileViewModel.doAction(GoNextPageGoalAction())),
            verticalSpace(16),
            InfoSelectionEditProfileWidget(
                title: context.localizations.youActivityLevel,
                titleForm:
                    editProfileViewModel.selectedPhysicalActivity.toString(),
                onTap: () => editProfileViewModel
                    .doAction(GoNextPagePhysicalActivityAction())),
            verticalSpace(20),
