          ...
          child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(context.localization.upcomingWorkouts,
                      style: AppFonts.font16KWightWeightW60Font,),
                    Text(context.localization.seeAll,
                      style: AppFonts.font14KWightPrimaryW400Font,),
                  ],
                ),
                verticalSpace(8),
                FilterListRow(
                  categories: exploreCubit.getUpcomingWorkTapList.map((e) =>e.strCategory ?? '').toList() ?? [],
                  selectedCategory: exploreCubit.currentCategory,
                  onCategorySelected: (category)=>exploreCubit.doAction(ChangeCurrentCategoryAction(category))
                ),
                verticalSpace(8),
