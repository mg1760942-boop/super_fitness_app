               ...
               children: <Widget>[
                 ...
                 Padding(
                   ...
                   child: Column(
                     ...
                     mainAxisAlignment: MainAxisAlignment.start,
                     children: [
                       Text("HOW OLD ARE YOU?",style: AppFonts.font20KWightWeightW800Font,),
                       verticalSpace(16),
                        Text("this helps us create Your personalized plan",style: AppFonts.font16KWightWeightW400Font,),
                     ],
                   ),
                 ),
         ...
         BluredContainer(
           ...
           padding: EdgeInsets.symmetric(horizontal: 16, vertical: 24),
             child: Column(children: [
               verticalSpace(8),
               Text("Year ",style: AppFonts.font12MainWeight400.copyWith(color: AppColors.primary),),
               verticalSpace(7),
           SizedBox(
             height: 50.h,
             child: ListView.separated(
               ...
               itemBuilder: (context, index) {
                 return GestureDetector(
                   ...
                   child: SizedBox(
                     width: 50.w,
                     height: 62.h,// Ensure uniform width for all items
                     child: Center(
                       child: Text(
                         index.toString(),
                         style: TextStyle(
                           color: index == _selectedIndex ? Colors.orange : Colors.white,
                           fontSize: index == _selectedIndex ? 44.sp : 32.sp,
               ...
               Icon(Icons.arrow_drop_up,color: AppColors.primary,size: 30,)
             ],
             ),
         ),
               ],)),
